...
public class rr_noisy_friction_test {
    ...
    private static int minChildren=128;
    ...
    private String query1 = "SELECT true_positioncg_n, true_positioncg_e, true_positioncg_altitude, fl_friction_noisy, fr_friction_noisy, rl_friction_noisy, rr_friction_noisy, unix_time FROM friction_measurement_uml_query_test ORDER BY true_positioncg_n, true_positioncg_e, unix_time LIMIT 200000";
...
//        }
        ...
        try {
            ...
            myWriter.write("Level,Min_n,Min_e,Min_time,Max_n,Max_e,Max_time,Num of children,Linear sum,Square sum,Parent lin sum,Average E \n");
            //myWriter.write(test_tree.asString(test_tree));
            myWriter.write(test_tree.asString3(test_tree, attributes));
            myWriter.close();
