...
public class time_test {
    ...
    private static List<String> dimension_attributes = new ArrayList<String>(Arrays.asList("true_positioncg_n", "true_positioncg_e", "true_positioncg_u"));
    ...
    private String query1 = "SELECT * FROM friction_measurement_uml_query_test ORDER BY true_positioncg_n, true_positioncg_e, true_positioncg_u LIMIT 1000000";

    // name of the file that the output is saved to
    public static String save_file_name = "time_test.csv";
    ...
    public static void main(String[] args) {
        ...
        time = stop_time - begin;
        System.out.println("Execution time for making rtree: " + time + " milliseconds");
        ...
        try {
            ...
            System.out.println("Execution time for writing output: " + executionTime + " milliseconds");
            myWriter.close();
