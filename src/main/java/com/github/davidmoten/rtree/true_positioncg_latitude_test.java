...
public class true_positioncg_latitude_test {
    ...
    private String query1 = "SELECT true_positioncg_n, true_positioncg_e, fl_friction_noisy FROM friction_measurement ORDER BY true_positioncg_n, true_positioncg_e LIMIT 1000";

    // name of the file that the output is saved to
    public static String save_file_name = "true_positioncg_latitude_test.txt";
    ...
    public static void main(String[] args) {
        ...
        test_tree.visualize(600, 600).save("target/test_location1000_rtree_" + maxChildren + "_data.png");
        try {
