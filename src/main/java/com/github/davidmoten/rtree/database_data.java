...
public class database_data {
    ...
    private String query1 = "SELECT true_positioncg_e, true_positioncg_n, true_positioncg_u, true_positioncg_latitude, true_positioncg_longitude, true_positioncg_altitude, fl_friction_noisy, fr_friction_noisy, rl_friction_noisy, rr_friction_noisy FROM friction_measurement_uml_query_test LIMIT 1000";
